...
public class BoardTest {
    ...
    public void testSet() {
        ...
        B.set(2, 2, 1, RED);
        B.set(4, 3, 3, BLUE);
        assertEquals("wrong number of spots", 3, B.get(4, 3).getSpots());
        assertEquals("wrong number of spots", 1, B.get(2, 2).getSpots());
        assertEquals("wrong number of spots", 1, B.get(3, 4).getSpots());
        assertEquals("wrong color", RED, B.get(2, 2).getSide());
        assertEquals("wrong color", BLUE, B.get(4, 3).getSide());
        ...
        assertEquals("wrong count", 23, B.numOfSide(WHITE));
    }
