...
class Display extends TopLevel implements View, CommandSource, Reporter {
    ...
    Display(String title) {
        ...
        addMenuButton("Game->Red AI", this::RedAi);
        addMenuButton("Game->Red Manuel", this::RedManual);
        addMenuButton("Game->Blue AI", this::BlueAi);
        addMenuButton("Game->Blue Manuel", this::BlueManual);
        addMenuButton("Game->Change Size", this::ChangeSize);
    ...
    /** set the current play to person. */
    ...
    /** change the size of the board before the game starts, but only to board size smaller than 6 x 6. */
    void ChangeSize(String dummy) {
        String input = getTextInput("Set the size", "board size", "input", "6");
        _commandQueue.offer("size " + Integer.parseInt(input) + "\n");
    }
